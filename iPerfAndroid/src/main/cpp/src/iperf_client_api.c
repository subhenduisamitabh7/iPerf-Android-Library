...
{
    __android_log_print(ANDROID_LOG_DEBUG, "IPERF", "##### ## iperf_connect");
    ...
    __android_log_print(ANDROID_LOG_DEBUG, "IPERF", "##### ## iperf_connect2 %s", test->server_hostname);
    __android_log_print(ANDROID_LOG_DEBUG, "IPERF", "##### ## test->server_port %d",test->server_port);
    __android_log_print(ANDROID_LOG_DEBUG, "IPERF", "##### ## test->settings->connect_timeout %d",test->settings->connect_timeout);
    ...
    __android_log_print(ANDROID_LOG_DEBUG, "IPERF", "##### ## iperf_connect3");

    if (test->ctrl_sck < 0) {
        i_errno = IECONNECT;
        return -1;
    }
    __android_log_print(ANDROID_LOG_DEBUG, "IPERF", "##### ## iperf_connect4");
...
iperf_run_client(struct iperf_test * test)
{
    ...
    __android_log_print(ANDROID_LOG_DEBUG, "IPERF", "##### ## before iperf_connect");
